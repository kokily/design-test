const NavMenu = [
  {
    ...
    url: '/about',
    items: [
      { id: 0, subTitle: 'Why The Y', subUrl: '/about/whythey' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 4, subTitle: '직무역량강화', subUrl: '/education/reinforce' },
      { id: 5, subTitle: '성과관리 커뮤니케이션', subUrl: '/education/performance ' },
  ...
  },
  {
    ...
    url: '/community',
    items: [
      { id: 0, subTitle: '공지사항', subUrl: '/community/notice' },
      { id: 1, subTitle: '교육문의', subUrl: '/community/question' },
    ],
  },
];
