...
function Carousel() {
  const Slide1 = (
    <div
      ...
      style={{
        backgroundImage: 'url(/assets/img/slides/slide-bg.jpg)',
    ...
    >
      <div className="position-absolute top-0 right-0 w-50pct w-lg-auto">
        <img
          src="/assets/img/slides/slide-devices.jpg"
      ...
      <div className="position-absolute top-50pct left-0 transform3dy-n50 w-50pct w-lg-auto">
        <img
          src="/assets/img/slides/slide-laptop.jpg"
          className="w-100 appear-animation"
      ...
      <div className="position-absolute transform3dy-n50">
        <img
          src="/assets/img/slides/slide-parallax-porto-symbol.png"
        ...
        <div className="d-flex flex-column align-items-center justify-content-center h-100">
          ...
          >
            <span className="position-absolute right-100pct top-50pct transform3dy-n50 opacity-3">
              <img
                src="/assets/img/slides/slide-title-border.png"
            ...
            <span className="position-relative">
              ...
              <span className="position-absolute left-50pct transform3dx-n50 top-0 mt-4">
                <img
                  src="/assets/img/slides/slide-blue-line.png"
                  className="w-auto appear-animation"
  ...
  const Slide2 = (
    <div
      ...
      data-dynamic-height="['670px','670px','670px','550px','500px']"
      style={{
        backgroundImage: 'url(/assets/img/slides/slide-bg-2.jpg)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        height: '670px',
      }}
  ...
  const Slide3 = (
    <div
      ...
      data-dynamic-height="['670px','670px','670px','550px','500px']"
      style={{
        backgroundImage: 'url(/assets/img/slides/slide-bg-6.jpg)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        height: '670px',
      }}
